            ...
            <motion.div
                ...
                className={`
                    ...
                    ${isPlaceholder
                        ...
                        : `bg-zinc-800/50 border-zinc-700/50 cursor-help hover:border-${color}-500/30 hover:bg-zinc-800`
                    }
                `}
            >
                ...
                <div className={`text-3xl font-bold ${isPlaceholder ? 'text-zinc-700' : `text-${color}-400`}`}>
